...
--	Healium_DebugPrint("Begin Healium_CreateAddonOptionFrame()")
	...
	TitleText:SetText(Healium_AddonColoredName .. Version .. " for Ascension WoW")
	-- Title subtext
	...
	HealiumClassIconTexture:SetTexture("Interface/Icons/Mail_GMIcon")
	...
	--HealiumClassIcon.Text:SetText("HERO")
...
--		HealiumDropDown[i].tooltipText = Healium_AddonColoredName .. " button"
    ...
    AboutFrame.Text:SetText(Healium_AddonColoredName .. Version .. "|n|cFFFFFFFFUpdated by Hezghul of Al'ar for Ascension (Discord: mazer#2226).|n|n|cFFFFFFFFOriginally created by Engy of Area 52.|n|cFFFFFFFFOriginally based on FB Heal Box, which was created by Dourd of Argent Dawn EU.")
